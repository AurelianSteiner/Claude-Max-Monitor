...
struct DiagnosticReport: Codable {
    ...
    func toMarkdown() -> String {
        var report = """
        # Claude Max Monitor Diagnostic Report
        ...
        **✅ Safe to share**: This report contains no complete credentials or personal data.
        ...
        - Report generated by Claude Max Monitor v\(appVersion)
        - For help, visit: https://github.com/AurelianSteiner/Claude-Max-Monitor/issues
...
enum DiagnosticMessage {
    ...
    static let suggestionContactSupport = "Contact developer for help at github.com/AurelianSteiner/Claude-Max-Monitor/issues"
